...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn('px-2 py-1.5 text-base font-normal data-[inset]:pl-8', className)}
      {...props}
    />
  )
}
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      className={cn('text-muted-foreground ml-auto text-base tracking-widest', className)}
      {...props}
    />
  )
}
